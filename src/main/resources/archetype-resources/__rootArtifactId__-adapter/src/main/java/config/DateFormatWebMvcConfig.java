...
@Configuration
public class DateFormatWebMvcConfig {
     ...
     * 必须使用匿名内部类才能正常处理，使用lambda表达式会出现IllegalArgumentException异常
     * 由于Lambda表达式接口返回的是Converter，并不能得到具体的类型
     */
    @Bean
    ...
    public Jackson2ObjectMapperBuilderCustomizer jackson2ObjectMapperBuilderCustomizer() {
        return builder -> builder
                ...
                .deserializerByType(String.class, StringTrimDeserializer.INSTANCE)
